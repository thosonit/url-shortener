...
REST API backend for the **ShortLink** project. Built with **Spring Boot 4** and **Java 17**, it provides all business logic for the ShortLink web application.
...
├── src/
│   ├── main/
│   │   ├── java/it/thoson/ShortLink/
│   │   │   ├── ShortLinkApplication.java           # Application entry point
│   │   │   │
...
│           └── ShortLinkApplicationTests.java
│
├── build.gradle
├── settings.gradle
├── gradlew
